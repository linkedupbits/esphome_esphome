...
async def to_code(config):
    ...
    var = cg.new_Pvariable(config[CONF_TFT_eSPI_ESPHome_Button_ID], espi, position_conf[CONF_X_POS], position_conf[CONF_X_POS], position_conf[CONF_WIDTH], position_conf[CONF_HEIGHT])
